...
{
    {
        ...
        CertificateTest.prototype.test_fromObject = function() {
            ...
            var obj = {
                "tbsCertificate":
                        {
                            ...
                            issuer: {rdnSequence: [{type: "2.5.29.3", value: Hex.toDer("020108")}]},
                            "validity": {
                                notBefore: {generalTime: new Date(2014, 8, 1)},
                                notAfter: {generalTime: new Date(2015, 8, 1)}
                            },
                            subject: {rdnSequence: [{type: "2.5.29.3", value: Hex.toDer("020109")}]},
                            subjectPublicKeyInfo: {
                                algorithm: {
                                    algorithm: "1.2.840.113549.1.1.1",
                                    parameters: Hex.toDer("0500")
                ...
                "signatureValue": new BitString(Hex.toDer("020304"), 0)

            };
            var tmp = new trusted.PKI.Certificate(obj);
            fail("Create certificate from object doesn't work!");
        };
        CertificateTest.prototype.test_checkValidity = function(){
            ...
            assertEquals(false,dps.checkValidity(new Date("2019-03-11 11:48:48 UTC"))); // равно окончанию
            assertEquals(false,dps.checkValidity(new Date("2019-03-12 11:48:48 UTC"))); // позже
        };
        CertificateTest.prototype.test_checkExtension_fromString = function(){
            var der = Hex.toDer("");
            var dps = new trusted.PKI.Certificate(der);
            var str = "2.5.29.16";
            assertEquals("2.5.29.16",(dps.getExtension(str)).OID.value);
        };
        CertificateTest.prototype.test_checkExtension_fromOID = function(){
            var oid = new trusted.PKI.Certificate();
            oid.value = "2.5.29.16";
            assertEquals("2.5.29.16",(getExtension(oid)));
        };
