...
//Тесты
{
    //Конструктор
    {
        ...
        ExtensionTest.prototype.test_Extension_New_1 = function() {
            assertException(function(){new trusted.PKI.Extension();});
        };
        ExtensionTest.prototype.test_Extension_New_2 = function() {
            ...
            assertEquals(new trusted.PKI.OID("2.5.29.15"),extn.extnID);
            assertEquals("03020106",Der.toHex(extn.extnValue));
        };
        ...
        ExtensionTest.prototype.test_Extension_New_3 = function() {
            ...
            assertEquals(new trusted.PKI.OID("2.5.29.14"),extn.extnID);
            assertEquals("04146B693D6A18424ADD8F026539FD35248678911630",Der.toHex(extn.extnValue));
        };
        ExtensionTest.prototype.test_Extension_New_4 = function() {
            assertException(function(){new trusted.PKI.Extension("Wrong value");});
        };
        ExtensionTest.prototype.test_Extension_New_5 = function() {
            assertException(function(){new trusted.PKI.Extension({critical:true,extnID:"2.25.4.16"});});
        };
    }
