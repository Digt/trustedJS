AlternativeNameTest = TestCase("TemplateTest");
...
//Тесты
{
    //Конструктор
    {
        ...
        AlternativeNameTest.prototype.test_AlternativeName_New_2 = function() {
            ...
            assertEquals("Val1;020101;countryName;aliasedEntryName=1+knowledgeInformation=2+commonName=3;surname=4+serialNumber=5+countryName=6;Val3", ian.toString());
        };
        // subject
